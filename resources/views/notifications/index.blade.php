...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <!-- Фильтры -->
    @php
        $notificationsIndexRoute = Str::startsWith(Request::path(), 'panel') ? 'panel.notifications.index' : 'notifications.index';
    @endphp
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 shadow-sm">
        <div class="flex items-center gap-2">
            <a href="{{ route($notificationsIndexRoute, ['filter' => 'all']) }}"
            ...
            <a href="{{ route($notificationsIndexRoute, ['filter' => 'unread']) }}"
            ...
            <a href="{{ route($notificationsIndexRoute, ['filter' => 'read']) }}"
                            ...
                            <div class="shrink-0 mt-0.5">
                                @php
                                    $iconConfig = [
                                        ...
                                        'subscription.payment.success' => ['icon' => 'fa-check-circle', 'color' => 'green'],
                                        'subscription.payment.failed' => ['icon' => 'fa-xmark-circle', 'color' => 'red'],
                                        'subscription.plan.changed' => ['icon' => 'fa-arrow-right-arrow-left', 'color' => 'indigo'],
                                        'subscription.renewed' => ['icon' => 'fa-rotate', 'color' => 'indigo'],
                                        'subscription.trial.started' => ['icon' => 'fa-gift', 'color' => 'amber'],
                                        'subscription.trial.ending' => ['icon' => 'fa-clock', 'color' => 'amber'],
                                        'client.new' => ['icon' => 'fa-user-plus', 'color' => 'indigo'],
                                        'business.user.invited' => ['icon' => 'fa-user-plus', 'color' => 'blue'],
                                        'business.user.joined' => ['icon' => 'fa-user-check', 'color' => 'blue'],
                                        'business.user.removed' => ['icon' => 'fa-user-minus', 'color' => 'red'],
                                        'business.user.role_changed' => ['icon' => 'fa-user-gear', 'color' => 'indigo'],
                                        'telegram.connected' => ['icon' => 'fa-paper-plane', 'color' => 'green'],
                                        'telegram.disconnected' => ['icon' => 'fa-paper-plane', 'color' => 'red'],
