        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-start sm:items-center gap-3 sm:gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white mb-1">Создание тарифа</h1>
                    <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Заполните форму ниже для создания нового тарифа</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('panel.plans.store') }}" id="plan-form" class="space-y-6">
            @csrf
                ...
                <div class="p-4 sm:p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            >
                                <option value="monthly" {{ old('interval', 'monthly') === 'monthly' ? 'selected' : '' }}>Ежемесячно</option>
                                <option value="yearly" {{ old('interval') === 'yearly' ? 'selected' : '' }}>Ежегодно</option>
                            </select>
                            @error('interval')
                                <p class="mt-2 text-xs text-rose-600 dark:text-rose-400 flex items-center gap-1" role="alert">
                                    <i class="fa-solid fa-circle-exclamation"></i>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <p class="mt-3 text-xs text-slate-500 dark:text-slate-400">
                        ...
                        Свойства можно добавить позже, это необязательно при создании тарифа
                    </p>
                </div>
            </div>
                        ...
                        <div class="hidden sm:flex items-center justify-between mb-4 pb-4 border-b border-slate-200 dark:border-slate-800">
                            <div class="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
                                ...
                                <div class="flex items-center gap-1.5" id="features-count-display">
                                    ...
                                    <span>Свойства: <strong class="text-slate-700 dark:text-slate-300" id="features-count">0</strong></span>
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (nameInput && slugInput && !slugInput.value) {
                ...
                nameInput.addEventListener('blur', function() {
                    if (!slugGenerated && !slugInput.value && this.value) {
