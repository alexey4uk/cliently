    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 sm:pb-8">
        <nav class="mb-4 sm:mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-slate-500 dark:text-slate-400 overflow-x-auto">
                ...
                <li class="flex-shrink-0"><i class="fa-solid fa-chevron-right text-xs"></i></li>
                <li class="flex-shrink-0 text-slate-900 dark:text-white font-medium">{{ $country->name }}</li>
            </ol>
        </nav>
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-start sm:items-center gap-3 sm:gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white mb-1">Редактировать страну</h1>
                    <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Измените данные страны</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('panel.countries.update', $country) }}" class="space-y-6">
            @csrf
            @method('PATCH')
                ...
                <div class="p-4 sm:p-6 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" id="code" name="code" value="{{ old('code', $country->code) }}" required maxlength="2" pattern="[A-Za-z]{2}"
                        ...
                        <div>
                            ...
                            <input type="text" id="code_3" name="code_3" value="{{ old('code_3', $country->code_3) }}" maxlength="3" pattern="[A-Za-z]{3}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $country->name_en) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="calling_code" name="calling_code" value="{{ old('calling_code', $country->calling_code) }}" required
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" id="currency" name="currency" value="{{ old('currency', $country->currency) }}" maxlength="10"
                        ...
                        <div>
                            ...
                            <input type="text" id="currency_symbol" name="currency_symbol" value="{{ old('currency_symbol', $country->currency_symbol) }}" maxlength="10"
                                class="w-full px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-indigo-500 text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="ioc" name="ioc" value="{{ old('ioc', $country->ioc) }}" maxlength="3"
            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <div class="px-4 sm:px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    @if($country->phones_count > 0)
                        <p class="text-xs sm:text-sm text-amber-600 dark:text-amber-400 mt-0.5">К этой стране привязано телефонов: {{ $country->phones_count }}</p>
                    @endif
                </div>
                <div class="p-4 sm:p-6 space-y-4">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_for_phone_select" value="1" {{ old('is_for_phone_select', $country->is_for_phone_select) ? 'checked' : '' }}
                            class="rounded border-slate-300 dark:border-slate-600 text-indigo-600 focus:ring-indigo-500">
