...
<div x-data="{
    ...
    openPhoneModal(e) {
        ...
        if (!btn) return;
        window.dispatchEvent(new CustomEvent('phone-modal-open', {
            detail: {
    ...
    <div class="rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 p-4">
        <p class="text-amber-800 dark:text-amber-200 font-medium">Создайте бизнес или примите приглашение, чтобы управлять записями.</p>
