...
@section('title', 'Нет доступных услуг')
...
@section('content')
    <div class="w-full">
        <div class="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 sm:p-8 text-center">
            ...
            <h3 class="text-base font-semibold text-slate-900 dark:text-white mb-1">Нет доступных услуг в этом филиале</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mb-4">В выбранном филиале пока нет услуг для онлайн-записи. Выберите другой филиал.</p>
