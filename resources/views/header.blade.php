    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex"></div> <!-- Пустой элемент для выравнивания -->
                <div class="flex items-center">
                    ...
                    <div class="ml-4 relative flex-shrink-0">
                        <button id="user-menu-button-desktop" class="flex text-sm rounded-full focus:outline-none">
                        ...
                        <div id="user-menu-desktop" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
