...
@section('title', 'Редактирование услуги - Cliently')
@section('page-title', 'Редактирование услуги')
@section('page-description', 'Изменение данных услуги')
...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Редактировать услугу</h1>
        <p class="text-slate-600 dark:text-slate-400 mt-1">Измените информацию об услуге</p>
    </div>
    ...
    <form method="POST" action="{{ route('services.update', $service) }}" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              rows="3" 
                              maxlength="1000"
                              class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-slate-900 text-slate-900 dark:text-white resize-none transition-colors">{{ old('description', $service->description) }}</textarea>
        ...
        @php
            ...
            $serviceMasterIds = $service->masters->pluck('id')->toArray();
        @endphp
        @if($masters->count() > 0)
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-6">
