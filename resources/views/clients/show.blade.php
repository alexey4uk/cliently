                    ...
                    <div x-show="actionsMenuOpen"
                        ...
                        <div class="py-1">
                            ...
                            <button type="button"
                                ...
                                <i class="fa-solid fa-trash text-xs w-5"></i>
                                <span>Удалить</span>
                            </button>
                        </div>
                    </div>
        ...
        <div class="p-4 md:p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div>
                    ...
                    <p class="text-sm md:text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2">
        ...
        <div @click.stop
            ...
            <div class="px-4 md:px-6 py-4 md:py-5">
                <p class="text-sm md:text-base text-slate-700 dark:text-slate-300 mb-6">
                    Вы уверены, что хотите удалить клиента <span class="font-semibold">{{ $client->full_name }}</span>? Это действие нельзя отменить.
                </p>
