...
@section('content')
    ...
    <div class="space-y-4 md:space-y-6">
        ...
        <div class="rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 p-4">
            <p class="text-amber-800 dark:text-amber-200 font-medium">Создайте бизнес или примите приглашение, чтобы вести клиентскую базу.</p>
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <button type="button" data-phone-modal-trigger
                                            ...
                                            data-phone-display="{{ $client->phone }}"
