...
<form method="POST" action="{{ route('settings.masters.update', $master) }}" class="space-y-4 md:space-y-6">
    @csrf
    @method('PATCH')
        ...
        <div class="p-4 md:p-6 space-y-4 md:space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="first_name" name="first_name" required value="{{ old('first_name', $master->first_name) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $master->last_name) }}"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="specialization" name="specialization" required value="{{ old('specialization', $master->specialization) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" id="phone" name="phone" required value="{{ old('phone', $master->phone) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $master->email) }}"
        ...
        <div class="p-4 md:p-6 space-y-4 md:space-y-5">
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div x-data="{
                        open: false,
                        selectedDays: new Set({{ json_encode(old('working_hours.days_off', $workingHours['days_off'] ?? [])) }}),
                        days: {
                            'monday': 'Понедельник',
                            'tuesday': 'Вторник',
                            'wednesday': 'Среда',
                        ...
                        init() {
                            // Инициализируем выбранные дни из старых значений формы или из данных мастера
                            const oldDays = {{ json_encode(old('working_hours.days_off', $workingHours['days_off'] ?? [])) }};
