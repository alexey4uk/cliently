...
<form method="POST" action="{{ route('settings.locations.update', $location) }}" class="space-y-6">
    @csrf
    @method('PATCH')
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 md:p-6">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" required value="{{ old('name', $location->name) }}"
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" id="city" name="city" required value="{{ old('city', $location->city) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="street" name="street" required value="{{ old('street', $location->street) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="house" name="house" required value="{{ old('house', $location->house) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="building" name="building" value="{{ old('building', $location->building) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="apartment" name="apartment" value="{{ old('apartment', $location->apartment) }}"
                                       class="w-full px-2.5 md:px-3 py-2 md:py-2.5 text-base md:text-sm rounded-md border border-slate-300 dark:border-slate-700 focus:ring-indigo-500 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:border-transparent transition-colors">
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 md:p-6">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" required value="{{ old('phone', $location->phone) }}"
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" id="workingHours24" name="working_hours[24_hours]" value="1"
                                   ...
                                   {{ old('working_hours.24_hours', $workingHours['24_hours'] ?? false) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            @php
                                ...
                                $oldDaysOff = old('working_hours.days_off', $workingHours['days_off'] ?? []);
                            @endphp
