    ...
    <div class="max-w-2xl mx-auto">
        <div class="space-y-6">
            ...
            <div>
                ...
                <p class="text-slate-600 dark:text-slate-400 mt-1">Добавление нового Telegram бота в систему</p>
            </div>
                ...
                <form action="{{ route('panel.telegram.management.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="token" name="token" required value="{{ old('token') }}"
